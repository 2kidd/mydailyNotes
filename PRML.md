...
该学科的基础与内涵包含的太多了：哲学、数学、经济学、统计学、神经科学、心理学、计算机科学、控制论、信号处理、语言学等等。
...
是模式分类的方法，也就是确定一个样本的“类别属性”的过程。常用的术语有模式空间（实体对象）、特征空间（特征向量）、类别空间（类别）。记住“模式”是数据或者所有样本的潜在和内部的规律、结构或者关系，是模式识别的目标，我们算法的目的就是为了发现这些数据中的抽象规律（模式），而使得能够根据这个“模式”来“识别”物体，识别物体是什么、属于什么。
...
![image-20260415110811194](./assets/image-20260415110811194.png)
...
3.Occam‘s Razor Theorem（奥卡姆剃刀原理）：
